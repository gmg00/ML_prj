...
if __name__ == '__main__':
    ...
    do_grid_search = True
    best_comb_filename = '/mnt/c/Users/HP/Desktop/UNI/LM_1/MachineLearning/ML_prj/data/output/best_comb7.pkl'
    param_grid_filename = '/mnt/c/Users/HP/Desktop/UNI/LM_1/MachineLearning/ML_prj/data/output/param_grid7.pkl'
    # DATASET ACQUISITION
    ...
    if do_grid_search:
        params = {
              'eta' : [0.1, 0.085, 0.075, 0.09, 0.08, 0.15, 0.95],
              'lam' : [0.00003, 0.000009, 0.00001, 0.00002,0.000008],
              'alpha':[0.09, 0.08, 0.1, 0.095, 0.07, 0.085],
              'epochs': [500],
              'n_batch' : ['batch'],
